...
// Store our API endpoint inside queryUrl to call the earthquake website  
var queryUrl =  "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";


// Perform a GET request to the query URL. First we pass the location of json(queryUrl) and then we pass the function to get the data from the url
d3.json(queryUrl, function(data) {
  
  // Once we get a response, send the data.features object(key in the geojson file) to the createFeatures function. dta is the placeholder
...
function createMap(earthquakes) {
  ...
  // Define streetmap and darkmap layers. we use two variable to alternate the options when running it
